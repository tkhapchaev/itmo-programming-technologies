...
public class UserController {
    ...
    public UserController(UserService userService, RoleService roleService, OwnerService ownerService) {
    ...
    public ResponseEntity<?> save(@RequestBody UserDto userDto) {
        userService.save(new User(userDto, roleService.getById(userDto.getRole()), ownerService.getById(userDto.getOwner())));
    ...
    public ResponseEntity<?> update(@RequestBody UserDto userDto) {
        final boolean updated = userService.update(new User(userDto, roleService.getById(userDto.getRole()), ownerService.getById(userDto.getOwner())));
